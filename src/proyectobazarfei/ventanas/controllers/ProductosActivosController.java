...
public class ProductosActivosController {
    ...
    @FXML
    private FlowPane listaProductosActivosFlowPane;

    @FXML
    private ScrollPane listaProductosActivosScrollPane;
    ...
    @FXML
    private AnchorPane productosActivosAnchorPane;
    ...
    public void initialize() {
        ...
        if (perfil == null) {
            LogManager.error("No existe un perfil de usuario (ProductosActivosController).");
            return;
        }

        List<TransaccionVO> productosActivos = transaccionDAO.obtenerProductosActivosPorPerfilId(perfil.getId());
        cargarProductosActivosDelUsuario(productosActivos);
    }
     
    private void cargarProductosActivosDelUsuario(List<TransaccionVO> transacciones) {
        listaProductosActivosFlowPane.getChildren().clear();
    ...
    void perfil(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/PerfilPropio.fxml");
    }

    @FXML
    void menu(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Menu.fxml");
    }
    
    @FXML
    void publicarProducto(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/PublicarProducto.fxml");
    }

    @FXML
    void productosActivos(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/ProductosActivos.fxml");
    }

    @FXML
    void chats(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Chats.fxml");
    }

    @FXML
    void compras(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Compras.fxml");
    }

    @FXML
    void ventas(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Ventas.fxml");
    }

    @FXML
    void configuracion(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Configuracion.fxml");
    }

    @FXML
    void ayuda(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Ayuda.fxml");
    }

    @FXML
    void cerrarSesion(MouseEvent event) throws IOException {
        new CambiarVentana(productosActivosAnchorPane, "/proyectobazarfei/ventanas/fxml/Login.fxml");
    }
