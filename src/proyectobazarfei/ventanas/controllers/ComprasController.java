...
public class ComprasController {
    ...
    public void initialize() {
        ...
        if (perfil == null) {
            LogManager.error("No existe un perfil de usuario (ComprasController).");
            return;
        }

        List<TransaccionVO> compras = transaccionDAO.obtenerComprasPorPerfilId(perfil.getId());
        cargarComprasDelUsuario(compras);
    }
     
    private void cargarComprasDelUsuario(List<TransaccionVO> transacciones) {
